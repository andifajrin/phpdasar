...
$mhs = query("SELECT * FROM dataguru WHERE id = $id")[0];
//var_dump($mhs);
    ...
    <center><h1>Ubah data Siswa</h1></center>
        ...
        <table cellspacing="10" cellpadding="3" align="center" class="t1">
            ...
            <tr>
                ...
                <td> : <input type="text" name="nip" id="nip" required value="<?= $mhs["nip"]; ?>"></td>
            </tr>
            <tr>
            ...
            <tr>
                <td><label for="mp">Mata P3elajaran</label></td>
                <td> : <input type="text" name="mp" id="mp" required value="<?= $mhs["mp"]; ?>"></td>
            <tr>
        ...
        <center style="margin-top: 10px;"> <br><a class="home" href="guru.php">Kembali</a></center>
    </body>
</html>